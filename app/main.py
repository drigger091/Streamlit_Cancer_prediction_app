...
def add_sidebar():
  st.sidebar.header(" Adjust Cell Nuclei Measurements")
...
def main():
    ...
    try:
        ...
        st.error(f"An error occurred while adding sidebar: {e}")
        return
    ...
    try:
        ...
        st.error(f"An error occurred while generating radar chart: {e}")

    try:
        with col2:
            add_predictions(input_data)
    except Exception as e:
        st.error(f"An error occurred while adding predictions: {e}")
