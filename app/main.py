...
def add_predictions(input_data):
    ...
    st.subheader("Cless Cluster prediction")
    ...
    st.write("Probabilit of being benign:",model.predict_proba(input_array_scaled)[0][0])
    st.write("Probabilit of being Malicious:",model.predict_proba(input_array_scaled)[0][1])
    st.write("This app is only for experimental purpose , always consult medical professionals for help")
...
def main():
    ...
    with st.container():
        ...
        st.write("""Please connect this app to your cytology lab to help diagnose breast cancer from your tissue sample. 
             This app predicts using a machine learning model whether a breast mass is benign or malignant based on the measurements 
